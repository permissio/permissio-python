...
class PermissioError(Exception):
    """
    Base exception for all Permissio.io SDK errors.
...
class PermissioValidationError(PermissioError):
    """
...
class PermissioApiError(PermissioError):
    """
    ...
    def __str__(self) -> str:
        parts = [f"PermissioApiError: {self.message}"]
    ...
    def __repr__(self) -> str:
        return (
            f"PermissioApiError(message={self.message!r}, status_code={self.status_code}, "
            f"code={self.code!r}, details={self.details!r}, request_id={self.request_id!r})"
        )


class PermissioNetworkError(PermissioError):
    """
...
class PermissioTimeoutError(PermissioNetworkError):
...
class PermissioRateLimitError(PermissioApiError):
    """
...
class PermissioAuthenticationError(PermissioApiError):
...
class PermissioPermissionError(PermissioApiError):
...
class PermissioNotFoundError(PermissioApiError):
...
class PermissioConflictError(PermissioApiError):
