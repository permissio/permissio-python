...
from permissio import ConfigBuilder, Permissio, PermissioConfig
from permissio.enforcement import ContextBuilder, ResourceBuilder, UserBuilder
...
class TestNormalizeFunctions:
    ...
    def test_normalize_user_object(self):
        from permissio.enforcement.models import CheckUser, normalize_user
